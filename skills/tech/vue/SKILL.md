...
Provide Vue 3 Composition API expertise: script setup, reactivity system, component patterns, and built-in features. Exists to ensure Vue applications use the modern Composition API consistently and idiomatically.

## Rule

Vue 3 rules: 1) Always use Composition API with <script setup lang="ts">, 2) Prefer shallowRef over ref unless deep reactivity needed, 3) Composables for reusable logic, 4) defineProps/defineEmits with TypeScript generics, 5) Never use Options API in new code.
